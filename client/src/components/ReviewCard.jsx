...
const ReviewCard = ({ imgURL, customerName, rating, feedback }) => {
    return (
        <div className="flex justify-center items-center flex-col shadow-3xl bg-white p-10 rounded-[20px]" style={{ margin: '10px' }}>
            ...
            <div className="mt-3 flex justify-center items-center gap-2.5">
                ...
                <p className="text-xl font-montserrat text-slate-gray para-rev">{rating}</p>
            </div>
